        ...
        <div className="container">
          <div style={{ display: "flex", flexWrap: "wrap", gap: "4rem" }}>
            <div style={{ flex: "1 1 300px" }}>
              <h2 style={{ color: "var(--color-gold)", marginBottom: "2rem", textAlign: "left", whiteSpace: "nowrap", fontSize: "clamp(2rem, 3vw, 2.5rem)" }}>Get In Touch</h2>
            ...
            <div style={{ flex: "2 1 400px" }}>
              <h2 style={{ color: "var(--color-gold)", marginBottom: "2rem", textAlign: "left", fontSize: "clamp(2rem, 3vw, 2.5rem)" }}>Location</h2>
